...
class Modelo:
	    ...
	    f = open('/home/raul/tageador1/salida.split', 'rU')
            #f1= open('/media/raul/datos/tageador1/salida.dbp.in', 'w')
            f1= open('/home/raul/Argumentos-P/salida.dbp.in', 'w')
            pareja1=[]
            for line in f: 
                print line 
                line=line.strip()
        ...
        def entrenar(self):       
            os.system("java -server -Xms800m -Xmx800m -cp /home/raul/dbparser/dbparser.jar -Dparser.settingsFile=/media/raul/datos/dbparser/settings/arabic.properties danbikel.parser.Trainer -i /home/raul/PTB-M/training-data5.mrg -o /home/raul/PTB-M/training-data5.observed.gz -od /media/datos/PTB-M/training-data5.obj.gz") 
        def testear(self):
            os.system("	java -server -Xms500m -Xmx500m -cp /home/raul/dbparser/dbparser.jar -Dparser.settingsFile=/home/raul/dbparser/settings/arabic.properties danbikel.parser.Parser -is /home/raul/PTB-M/training-data5.obj.gz -sa /home/raul/Argumentos-P/salida.dbp.in")
        def tageador(self):
            self.ejecute()
            self.entrenar()
            self.testear() 
...
if __name__ == "__main__":
        ...
        model.entrenar()
        model.testear()
        text2='/home/raul/PtbRoot/00/wsj_0002.mrg'
        text1= '/home/raul/tages/Arg_002.mrg'
