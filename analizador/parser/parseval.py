...
########## Execution start here ##########    
    ...
    estadistica = open("/priimerproyecto/PLN/analizador/Resultados/estadisticas.txt", "w+")
    startTag = '('
    endTag = ')'
    ...
    estadistica.write("Precision promedia: " + str(pre1) + "\n")
    estadistica.write("Recall: " + str(re1) + "\n")
    estadistica.write("cross brackets: " + str(crossing) + "\n")
    estadistica.write("F-score: " + str(fscore))
    estadistica.close()
