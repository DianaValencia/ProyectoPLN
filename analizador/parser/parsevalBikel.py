...
def parseval(files1,files2,argv):
    ...
    #El archivo que guarda la estadistica.   
    estadisticaBikel = open("/priimerproyecto/PLN/analizador/Resultados/estadisticasBikel.txt", "w+")
    startTag = '('
    endTag = ')'
...
#propuesto sobre el numero de constituyentes en el treebank parse
    ...
    estadisticaBikel.write("Precision promedia: " + str(pre1) + "\n")
    estadisticaBikel.write("Recall: " + str(re1) + "\n")
    estadisticaBikel.write("cross brackets: " + str(crossing) + "\n")
    estadisticaBikel.write("F-score: " + str(fscore))
    estadisticaBikel.close()
