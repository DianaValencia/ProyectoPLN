...
def ejecutar():
    ...
    archivoLectura = open("/priimerproyecto/PLN/analizador/Resultados/resultadoParserSTD.txt", "r+")
    archivoEscrituraArbol = open("/priimerproyecto/PLN/analizador/Resultados/arbolesExtraidosSTD.txt", "w+")
    archivoEscrituraDependencias = open("/priimerproyecto/PLN/analizador/Resultados/dependenciasExtraidasSTD.txt", "w+")
    ...
    #Se cierran los archivos de lectura y escritura que se usarion
